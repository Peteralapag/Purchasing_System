	        ...
	        <?php if ($po['closed_po'] != 1): ?>
	            ...
	            <?php if ($po['status'] === 'APPROVED'): ?>
	                <button class="btn btn-danger btn-sm"
	                    onclick="voidPO('<?= $po['po_number'] ?>','<?= $po['pr_number'] ?>')">
	                    <i class="fa fa-ban"></i> Void Purchase Order
	                </button>
	            <?php endif; ?>
	
	            <?php if ($po['status'] === 'PARTIAL_RECEIVED'): ?>
	                <button class="btn btn-warning btn-sm"
	                    onclick="closePO('<?= $po['po_number'] ?>','<?= $po['pr_number'] ?>')">
	                    <i class="fa-solid fa-lock"></i> Close this PO
	                </button>
	            <?php endif; ?>
	        ...
	        <?php if ($po['status'] == 'PENDING'): ?>
	            ...
	            <div class="no-print">
	                ...
	                <button class="btn btn-success btn-sm"
	                        onclick="approvePO('<?= $po['po_number'] ?>','<?= $po['pr_number'] ?>')">
...
function approvePO(poNumber, prnumber) {
...
function voidPO(poNumber, prNumber) {
    swal({
