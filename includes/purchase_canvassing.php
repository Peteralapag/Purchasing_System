...
<div class="smnav-header">
    <span style="display:flex;gap:10px">
        <div class="search-shell">
            <input id="search" type="text" class="form-control form-control-sm" placeholder="Search canvassing no.">    
...
function load_data() {
    ...
    $.post("./Modules/Purchasing_System/includes/canvassing_data.php", { 
        limit: limit, 
        status: status
