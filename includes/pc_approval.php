...
<div class="smnav-header">
    <span style="display:flex;gap:10px">
        <div class="search-shell">
            <input id="search" type="text" class="form-control form-control-sm" placeholder="Search PC Approval.." autocomplete="off">    
...
$(function() {
    $('#search').keyup(function() {
        ...
        $('#canvassingtable tbody tr').each(function() {
...
function load_data() {
    ...
    $.post("./Modules/Purchasing_System/includes/pc_approval_data.php", { 
        limit: limit, 
        status: status
