...
<div class="smnav-header">
    <span style="display:flex;gap:10px">
        <div class="search-shell">
            <input id="search" type="text" class="form-control form-control-sm" placeholder="Search purchase order">    
   	...
   	<button type="button" class="btn btn-success btn-sm" onclick="addsupplier()">
   		<i class="fas fa-plus"></i> Add PO<span id="poPendingBadge" class="badge-notify" style="display:none"></span>
   	</button>
...
function load_data() {
    ...
    $.post("./Modules/Purchasing_System/includes/purchase_order_data.php", { 
        limit: limit, 
        status: status
...
function addsupplier(){
	...
	$.post("./Modules/Purchasing_System/apps/purchase_order_add.php", { },
	function(data) {		
...
function loadPendingPOSuppliers() {
    $.getJSON(
        "./Modules/Purchasing_System/actions/get_pending_po_suppliers.php",
        function(res) {
...
loadPendingPOSuppliers();
setInterval(loadPendingPOSuppliers, 10000);
