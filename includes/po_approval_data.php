...
if ($status !== '') {
    ...
    $sql .= "
        ...
        AND po.reviewed_by IS NOT NULL
        AND po.reviewed_date IS NOT NULL
...
function viewpo(ponumber,prnumber,suppliername){
	...
	$.post("./Modules/Purchasing_System/apps/po_approval_view_form.php", { ponumber: ponumber, prnumber: prnumber, suppliername: suppliername },
	function(data) {
		$('#contents').html(data);
	});
}
